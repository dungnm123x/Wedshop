            ...
            <div class="container-fluid" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto" style="left: 50px ">
                    ...
                    <li class="nav-item fw-bold">
                        ...
                        <li class="nav-item fw-bold">
                            <a class="nav-link" href="logout">Hello: ${acc.getFirstName()} ${acc.getLastName()}</a>
                        </li>   
                        <li class="nav-item fw-bold">
                ...
                <div class="row g-3">
                    <div class="col-6">
                        ...
                        <input name="image" 
                               readonly
                               hidden
                               id="imageInput" value="${pro.getProductImg()}" type="text" class="w-100 p-2"/>
                        <div class="position-relative">
                            <img id="previewImage" src="${pro.getProductImg()}" alt="alt" style="max-width: 200px; max-height: 200px;"/>
                    ...
                    <div class="col-6">
                        ...
                        <input name="name" value="${pro.getProductName()}" required class="w-100 p-2"/>
                    </div>
                    <div class="col-6">
                        <label class="fw-bold fs-5">Available </label>
                        <input name="available"
                               value="${pro.getAvailable()}" 
                               required
